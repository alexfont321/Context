        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HistoricalLink = table.Column<string>(nullable: false),
                    AuthorInfo = table.Column<string>(nullable: true),
                    BookInfo = table.Column<string>(nullable: true),
                    CountryInfo = table.Column<string>(nullable: true),
                    HistoricalInfo = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                table: "Books",
                columns: new[] { "BookId", "AuthorFirstName", "AuthorInfo", "AuthorLastName", "BookInfo", "Country", "CountryInfo", "HistoricalInfo", "HistoricalLink", "Title" },
                values: new object[] { 1, "Fyodor", null, "Dostoevsky", null, "Russia", null, null, "https://en.wikipedia.org/wiki/Emancipation_reform_of_1861", "Crime and Punishment" });
